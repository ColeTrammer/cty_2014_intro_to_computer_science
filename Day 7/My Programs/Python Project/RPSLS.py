...
def rpsls(a, b):
    if a == 1 and b == 3 or a == 1 and b == 4 or a == 2 and b == 1 or a == 2 and b == 5 or a == 3 and b == 2 or a == 3 \
       and b == 4 or a == 4 and b == 2 or a == 4 and b == 5 or a == 5 and b == 1 or a == 5 and b == 3:
        return "\nYOU WIN!!!"
    elif a == b:
        return "\nTIE!!!"
    else:
...
def main():
    """
    Program by Cole to play rock, paper, scissors, lizard, spock!!!
    """
    ...
    while True:
        try:
            ...
            error = 0              # error needs to reset to prevent false inputs
            if person == "rock":
                print "you: rock"
                a = 1
                count += 1
